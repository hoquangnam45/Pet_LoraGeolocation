...
uint32_t LoRaClass::receiveTimeStamp = 0, LoRaClass::sendTimeStamp = 0;
LoRaClass::LoRaClass() :
...
int LoRaClass::endPacket()
{
  ...
  sendTimeStamp = ESP.getCycleCount();
  // clear IRQ's
...
{
  receiveTimeStamp = ESP.getCycleCount();
  LoRa.handleDio0Rise();
}
uint32_t LoRaClass::getReceiveTimeStamp(){
    return receiveTimeStamp;
}
uint32_t LoRaClass::getSendTimeStamp(){
